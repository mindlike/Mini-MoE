...
from models.MoE.model import GPTConfig, GPT

# Load the configuration from the JSON file
config = configurator.load_config_from_json('config.json')

# Update the configuration with command line arguments
config = configurator.update_config_with_args(config, sys.argv[1:])

# Convert the dictionary to a named tuple
Config = namedtuple("Config", config.keys())
config = Config(**config)

# Now you can use the config parameters in your script
# For example:
# -----------------------------------------------------------------------------
